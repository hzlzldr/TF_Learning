...
import sys
sys.path.append("C:/Users/acer/Documents/GitHub/TF_Learning")
import os
import tensorflow as tf
from tensorflow.examples.tutorials.mnist import input_data

from ch_4 import mnist_cnn
...
def train(mnist):
    ...
    x=tf.placeholder(tf.float32,shape=[None,mnist_cnn.INPUT_NODE],name='x_input')
    y_=tf.placeholder(tf.float32,shape=[None,mnist_cnn.OUTPUT_NODE],name='y_input')


    regularizer=tf.contrib.layers.l2_regularizer(REGULARIZATION_RATE)
    y=mnist_cnn.nn(input_tensor=x,train=True,regularizer=regularizer)
